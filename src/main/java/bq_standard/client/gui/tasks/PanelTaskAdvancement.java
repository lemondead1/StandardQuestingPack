...
public class PanelTaskAdvancement extends CanvasEmpty {
  ...
  public void initPanel() {
    ...
    Advancement adv = task.advID == null ? null : player.connection.getAdvancementManager().getAdvancementList()
                                                                   .getAdvancement(task.advID);
    ...
    this.addPanel(new PanelTextBox(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(28, 2, 0, -12), 0), title)
                      .setColor(PresetColor.TEXT_MAIN.getColor()));
    String s = isComplete ? (TextFormatting.GREEN + QuestTranslation.translate("betterquesting.tooltip.complete"))
                          : (TextFormatting.RED + QuestTranslation.translate("betterquesting.tooltip.incomplete"));
    this.addPanel(new PanelTextBox(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(28, 14, 0, -24), 0), s)
                      .setColor(PresetColor.TEXT_MAIN.getColor()));
    this.addPanel(new PanelTextBox(new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(0, 32, 0, 0), 0), desc)
                      .setColor(PresetColor.TEXT_MAIN.getColor()));
  }
}
