...
public class PanelTaskCrafting extends CanvasEmpty {
  ...
  public void initPanel() {
    ...
    this.addPanel(
        new PanelGeneric(new GuiRectangle(0, 0, 24, 24, 0), new ItemTexture(new BigItemStack(Blocks.CRAFTING_TABLE))));
    this.addPanel(new PanelGeneric(new GuiRectangle(16, 16, 8, 8, 0), task.allowCraft ? txTick : txCross));

    this.addPanel(
        new PanelGeneric(new GuiRectangle(32, 0, 24, 24, 0), new ItemTexture(new BigItemStack(Blocks.FURNACE))));
    this.addPanel(new PanelGeneric(new GuiRectangle(48, 16, 8, 8, 0), task.allowSmelt ? txTick : txCross));

    this.addPanel(
        new PanelGeneric(new GuiRectangle(64, 0, 24, 24, 0), new ItemTexture(new BigItemStack(Blocks.ANVIL))));
    ...
    PanelVScrollBar scList =
        new PanelVScrollBar(new GuiTransform(GuiAlign.RIGHT_EDGE, new GuiPadding(-8, 32, 0, 0), 0));
