...
public class PanelRewardChoice extends CanvasEmpty {
  ...
  public void initPanel() {
    ...
    PanelItemSlot slot = new PanelItemSlot(new GuiTransform(new Vector4f(0F, 0.5F, 0F, 0.5F), 0, -16, 32, 32, 0), -1,
    ...
    for (int i = 0; i < reward.choices.size(); i++) {
      ...
      cvList.addPanel(new PanelTextBox(new GuiRectangle(22, i * 18 + 4, listWidth - 22, 14, 0),
                                       stack.stackSize + " " + stack.getBaseStack().getDisplayName()).setColor(
