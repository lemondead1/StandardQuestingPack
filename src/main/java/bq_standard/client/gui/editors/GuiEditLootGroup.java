    ...
    for (int i = 0; i < lgAry.size(); i++) {
      lootList.addPanel(
          new PanelButtonStorage<>(new GuiRectangle(0, i * 16, 16, 16, 0), -1, "", lgAry.get(i)).setCallback(value ->
                                                                                                             {
                                                                                                               LootRegistry.INSTANCE.removeID(
                                                                                                                   value.getID());
                                                                                                               refreshGroups();
                                                                                                               SendChanges();
                                                                                                             }).setIcon(
      ...
      lootList.addPanel(
          new PanelButtonStorage<>(new GuiRectangle(16, i * 16, lWidth - 16, 16, 0), -1, lgAry.get(i).getValue().name,
                                   lgAry.get(i)).setCallback(value ->
                                                             {
                                                               ...
                                                               int totalWeight = LootRegistry.INSTANCE.getTotalWeight();
                                                               float chance =
                                                                   selGroup.weight / (float) totalWeight * 100F;
                                                               textWeight.setText(
